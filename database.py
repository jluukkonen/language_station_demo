...
SAMPLE_TEXTS = {
    "Microbiology (Main Demo)": {
        ...
        "fi": "Moniresistentit bakteerit, kuten Staphylococcus aureus (MRSA), muodostavat merkittävän haasteen nykyaikaisissa terveydenhuoltojärjestelmissä. Nämä patogeenit ovat kehittäneet resistenssiä useille antibioottiluokille geneettisten mutaatioiden ja horisontaalisen geeninsiirron kautta. Tämän seurauksena tavanomaiset hoitokäytännöt ovat usein tehottomia, mikä johtaa pitkittyneisiin sairaalajaksoihin, lisääntyneeseen sairastavuuteen ja korkeampaan kuolleisuuteen.\n\nMRSA:n patogeneesi perustuu monimutkaisiin vuorovaikutuksiin bakteerin virulenssitekijöiden ja isännän immuuvasteen välillä. Keskeisiä tekijöitä ovat biofilmin muodostus, toksiinien tuotanto sekä immuunipuolustuksen välttäminen. Kliinisissä ympäristöissä varhainen diagnosointi ja infektiontorjuntatoimenpiteet ovat keskeisiä sairaalainfektioiden leviämisen ehkäisemiseksi."
    },
    "Public & Planetary Health": {
        "en": "Public and planetary health examines the interconnected relationship between human health and environmental systems. Climate change, biodiversity loss, and pollution are increasingly recognized as key determinants of global health outcomes. These environmental stressors influence the spread of infectious diseases, food security, and population-level morbidity.\n\nEffective responses require interdisciplinary approaches that integrate epidemiology, environmental science, and public policy. Health professionals must be able to communicate complex scientific concepts across linguistic and cultural boundaries, particularly in multilingual and international contexts.",
        "fi": "Kansanterveys ja planetaarinen terveys tarkastelevat ihmisten terveyden ja ympäristöjärjestelmien välistä yhteyttä. Ilmastonmuutos, biodiversiteetin väheneminen ja saastuminen tunnistetaan yhä useammin keskeisiksi globaalin terveyden määrääjiksi. Nämä ympäristötekijät vaikuttavat tartuntatautien leviämiseen, ruokaturvaan sekä väestön sairastavuuteen.\n\nTehokkaat ratkaisut edellyttävät monitieteisiä lähestymistapoja, jotka yhdistävät epidemiologian, ympäristötieteen ja terveyspolitiikan. Terveydenhuollon ammattilaisten on kyettävä viestimään monimutkaisia tieteellisiä käsitteitä eri kielten ja kulttuurien välillä, erityisesti monikielisissä ympäristöissä."
    },
